...
import 'package:srishti/core/services/auth_service.dart';
...
class _AuthFormState extends State<AuthForm> {
  ...
  Widget _buildSubmitButton() => ElevatedButton(
        ...
        child: _isLoading ? const SizedBox(height: 20, width: 20, child: CircularProgressIndicator(strokeWidth: 2, color: Colors.black)) : Text(_isLoginView ? 'Login' : 'Create Account', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
      );
